    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="admin-beneficiarios.html" class="sidebar-link">Beneficiarios</a>
                <a href="admin-restaurantes.html" class="sidebar-link">Restaurantes</a>
                <a href="admin-perfil.html" class="sidebar-link activo">Perfil</a>
                ...
                <div class="formulario-card" style="max-width: 550px;">
                            ...
                            <div class="campo">
                                ...
                                <input type="text" class="campo-input" id="nombreCompleto" name="nombreCompleto"
                                    value="Juan Carlos Ramirez">
                            </div>

                            <div class="campo">
                                <label for="cedulaIdentidad" class="label-campo">Cedula de Identidad</label>
                                <input type="text" class="campo-input" id="cedulaIdentidad" name="cedulaIdentidad"
                                    value="1-2003-2392">
                            </div>

                            <div class="campo">
                                <label for="telefono" class="label-campo">Teléfono</label>
                                <input type="text" class="campo-input" id="telefono" name="telefono" value="7387-3930">
                            </div>
                            ...
                            <button type="submit" class="btn-accion" id="btnGuardarAdmin">Guardar Cambios</button>
