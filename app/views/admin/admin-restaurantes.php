    ...
    <div class="layout">
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="index.php?page=admin_restaurantes" class="sidebar-link activo">Restaurantes</a>
        ...
        <main class="panel-contenido">
            ...
            <div class="estadisticas">
                ...
                <div class="estadistica-card">
                    <p>Restaurantes con Donaciones Disponibles</p>
                    <strong><?= $totalActivos['total'] ?></strong>
                </div>
                <div class="estadistica-card">
                    <p>Restaurantes sin Donaciones Disponibles</p>
            ...
            <table class="table table-bordered tabla-panel" id="tablaBeneficiarios">
                ...
                <tbody id="cuerpoTabla">
                    <?php foreach ($restaurantes as $r): ?>
                        <tr>
                            <td><?= htmlspecialchars($r['nombre_negocio']) ?></td>
                            <td><?= htmlspecialchars($r['tipo_establecimiento']) ?></td>
                            <td><?= htmlspecialchars($r['ubicacion']) ?></td>
                            <td><?= $r['donaciones_activas'] ?></td>
                            <td>
                                <button class="btn-tabla btn-eliminar-restaurante" data-id="<?= $r['id_restaurante'] ?>"
                                    data-nombre="<?= htmlspecialchars($r['nombre_negocio']) ?>">
