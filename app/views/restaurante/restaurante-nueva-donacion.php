...
<head>
    ...
    <title>AlimentTICO - Nueva Donación</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="campo">
                            ...
                            <input type="text" class="campo-input" id="cantidad" name="cantidad" placeholder="Ej: 3 porciones">
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="campo">
                            <label for="horaLimite" class="label-campo">Hora Límite de Recogida</label>
                            <input type="time" class="campo-input" id="horaLimite" name="horaLimite">
                        </div>
